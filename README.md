...
- **Cache over weights:** 6.25× the weights buys **2.25×** the score; the KV cache buys up to **7.8×** the speed without changing a parameter.
...
- **Inference Efficiency:** 27.5 vs. 42.4 ms per token, and speculative decoding measured 30–40% slower on this model pair.
